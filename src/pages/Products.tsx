    ...
    <div className="group rounded-xl border border-border bg-card hover:border-primary/30 hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col">
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="flex gap-2">
          <Link
            to={`/products/${product.id}`}
            className="inline-flex items-center justify-center gap-2 flex-1 py-2.5 px-4 rounded-lg border border-border bg-card text-foreground text-sm font-medium hover:bg-muted transition-all duration-300"
          >
            View Details
          </Link>
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 flex-1 py-2.5 px-4 rounded-lg bg-primary/10 text-primary text-sm font-medium hover:bg-primary hover:text-primary-foreground transition-all duration-300 group/btn"
          >
            Demo
